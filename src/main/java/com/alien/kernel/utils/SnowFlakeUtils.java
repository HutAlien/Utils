...
public class SnowFlakeUtils {
    ...
    public static SnowFlakeUtils getFlowIdWorkerInstance() {
        return flowIdWorker;
    }
    ...
    public static String getRandomId() {
        SnowFlakeUtils snowFlakeUtils = SnowFlakeUtils.getFlowIdWorkerInstance();
        String id = null;
        try {
            Long a = snowFlakeUtils.nextId();
            id = a.toString();
        } catch (Exception e) {
            log.error("生产随机ID出错", e);
            e.printStackTrace();
        }
        return id;
    }
